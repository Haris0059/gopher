...
// Prompt returns the full system-prompt usage block for the Read tool.
// Source: FileReadTool/prompt.ts — renderPromptTemplate()
func (f *FileReadTool) Prompt() string {
...
- If you read a file that exists but has empty contents you will receive a system reminder warning in place of file contents.`, MaxLinesToRead, PDFMaxPagesPerRead)
}
