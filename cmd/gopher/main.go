...
import (
	...
	pluginsBundled "github.com/Haris0059/gopher/pkg/plugins/bundled"
	"github.com/Haris0059/gopher/pkg/product"
	"github.com/Haris0059/gopher/pkg/prompt"
	"github.com/Haris0059/gopher/pkg/provider"
	"github.com/Haris0059/gopher/pkg/query"
	_ "github.com/Haris0059/gopher/pkg/server" // T89-T90: server types for direct-connect mode
	"github.com/Haris0059/gopher/pkg/session"
	"github.com/Haris0059/gopher/pkg/skills"
	"github.com/Haris0059/gopher/pkg/telemetry"
	"github.com/Haris0059/gopher/pkg/tools"
	"github.com/Haris0059/gopher/pkg/ui/theme"

	"github.com/Haris0059/gopher/pkg/memdir"
	confighooks "github.com/Haris0059/gopher/pkg/ui/hooks/config"
	diffhooks "github.com/Haris0059/gopher/pkg/ui/hooks/diff"
	memoryhooks "github.com/Haris0059/gopher/pkg/ui/hooks/memory"
	pluginhooks "github.com/Haris0059/gopher/pkg/ui/hooks/plugins"
	sessionhooks "github.com/Haris0059/gopher/pkg/ui/hooks/session"
)

// Version is the current gopher version.
// Patch segment is the count of Haris0059's commits on this project.
const Version = "0.3.049"
...
func main() {
	...
	// cmd/gopher/handlers/auto_mode.go.
	...
	// Handle --version
	if *showVersion {
		cliOk(fmt.Sprintf("gopher v%s (%s)", Version, product.ProductURL))
	}
